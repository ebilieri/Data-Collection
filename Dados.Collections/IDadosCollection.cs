...
namespace Dados.Collections
{
    ...
    /// colecao de alta performance para adicionar, recuperar e procurar um elemento em uma
    /// grande colecao de objetos.
    ...
    /// 
    /// </summary>
    public interface IDadosCollection
    {
        /// <summary>
        ...
        /// como um Set).
        ///** Caso seja chamado esta API com um valor que já foi mapeado para a chave e
